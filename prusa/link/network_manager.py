...
class NMAdapter:
    ...
    def _ap0_exists(self):
        ...
        service_file = str(files("prusa.link") /
                           "data" / "add-ap0.service-template")
    ...
    def _run(self):
        ...
        while self.running:
            ...
            if self.state == self.States.DORMANT:
                ...
                if self._state_timeout(self.HOTSPOT_TIMEOUT):
