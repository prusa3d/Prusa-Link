...
from old_buddy.settings import QUIT_INTERVAL, STATUS_UPDATE_INTERVAL_SEC, IP_UPDATER_LOG_LEVEL, SHOW_IP_INTERVAL
...
class IPUpdater:
    ...
    def update_local_ip(self):
        try:
            ...
            self.local_ip = NO_IP  # Yeah empty string means disconnected :/ sorry
            self.show_ip()
        else:
