...
class PrusaLink:
    ...
    def __init__(self):
        ...
        self.info_sender = InfoSender(self.serial, self.serial_reader,
                                      self.serial_queue, self.connect_api,
                                      self.state_manager, self.file_printer,
                                      self.model, self.lcd_printer)
